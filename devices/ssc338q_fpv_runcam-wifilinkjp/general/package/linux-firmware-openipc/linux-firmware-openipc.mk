...
ifeq ($(BR2_PACKAGE_LINUX_FIRMWARE_OPENIPC_RTW88),y)
define LINUX_FIRMWARE_OPENIPC_INSTALL_RTW88
	$(INSTALL) -m 755 -d $(TARGET_DIR)/lib/firmware/rtw88
	$(INSTALL) -m 644 -t $(TARGET_DIR)/lib/firmware/rtw88 $(LINUX_FIRMWARE_OPENIPC_PKGDIR)/files/rtw88/rtw8*.bin
endef
endif
...
define LINUX_FIRMWARE_OPENIPC_INSTALL_TARGET_CMDS
	...
	$(LINUX_FIRMWARE_OPENIPC_INSTALL_RTW88)
endef
