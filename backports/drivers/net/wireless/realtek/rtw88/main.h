...
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(4, 11, 0)
#include "compiler.h"
#endif
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(4, 19, 0)
...
#include "util.h"
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(4, 8, 0)
#include <linux/etherdevice.h>
#endif
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(5, 14, 0)
...
#if (BACKPORT_VERSION_CODE < KERNEL_VERSION(6, 6, 0))
/**
...
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(6, 8, 0)
/**
...
#if (BACKPORT_VERSION_CODE < KERNEL_VERSION(5, 8, 0)) || defined(RHEL_RELEASE) && (RHEL_RELEASE_CODE < RHEL_RELEASE_VERSION(8,0))
...
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(4, 7, 0)
...
void rtw_vif_port_config(struct rtw_dev *rtwdev, struct rtw_vif *rtwvif,
			 u32 config);
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(4, 14, 0)
