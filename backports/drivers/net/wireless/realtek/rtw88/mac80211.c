...
#include "debug.h"
#include "wow.h"
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(5, 11, 0)
#include "sar.h"
#endif
...
#if (BACKPORT_VERSION_CODE < KERNEL_VERSION(6, 11, 0))
...
#if (BACKPORT_VERSION_CODE >= KERNEL_VERSION(6, 0, 0))
				     u64 changed)
#else
				     u32 changed)
#endif
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(4, 6, 0)
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(5, 5, 0)
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(4, 20, 0)
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(4, 18, 0)
...
static void rtw_ops_sta_rc_update(struct ieee80211_hw *hw,
				  struct ieee80211_vif *vif,
#if BACKPORT_VERSION_CODE < KERNEL_VERSION(6, 13, 0)
...
#if BACKPORT_VERSION_CODE >= KERNEL_VERSION(6, 9, 0)
